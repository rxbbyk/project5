...
$(document).ready(function () {
   function populateCurrencyDropdown() {
      ...
      $.each(exchangeRates.rates, function (currencyCode) {
         const currencyName = allCurrencies[currencyCode] || currencyCode;
         $("#toCurrency").append(`<option value="${currencyCode}">${currencyName} (${currencyCode})</option>`);
      });
   }
   ...
   $("#toCurrency").change(function () {
      ...
      if (selectedCurrency && !isNaN(usdAmount)) {
         ...
         if (rate) {
            ...
            const currencyName = allCurrencies[selectedCurrency] || selectedCurrency;
            $("#resultCurrency").val(convertedAmount);
            $("#resultLabel").text(`${currencyName} (${selectedCurrency}):`);
         } else {
            $("#resultCurrency").val("---.--");
            $("#resultLabel").text("Rate not available");
         }
      }
   });
